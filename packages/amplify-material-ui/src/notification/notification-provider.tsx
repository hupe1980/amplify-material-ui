...
import { NotificationState, NotificationContext } from './use-notification-context';

export interface NotificationProviderProps {
  onShowNotification?: (message: NotificationState) => NotificationState;
}

export const NotificationProvider: React.FC<NotificationProviderProps> = ({ children, onShowNotification }) => {
